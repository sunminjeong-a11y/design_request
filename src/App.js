...
// ── Constants ────────────────────────────────────────────────
const STATUSES = [
  { id: "todo", label: "📥 요청 접수", color: "#6366f1", bg: "#eef2ff" },
  {
    id: "reviewing",
    label: "👀 디자인 검토 및 할당",
    color: "#f59e0b",
  ...
  { id: "in-progress", label: "🏃 진행 중", color: "#10b981", bg: "#ecfdf5" },
  { id: "done", label: "✅ 완료", color: "#6b7280", bg: "#f9fafb" },
];
const TYPES = [
  "배너/광고",
  "SNS 콘텐츠",
...
const PRIORITIES = [
  { id: "high", label: "높음", color: "#ef4444" },
  { id: "medium", label: "보통", color: "#f59e0b" },
  { id: "low", label: "낮음", color: "#10b981" },
];
const PUBLISH_TYPES = [
  {
    id: "online",
...
export default function App() {
  ...
  useEffect(() => {
    ...
    if (hash.includes("access_token")) {
      ...
      if (token) {
        ...
        if (providerToken) {
          ...
          try {
            localStorage.setItem("g_token", providerToken);
          } catch {}
        }
    ...
    try {
      const gt = localStorage.getItem("g_token");
      if (gt) _googleToken = gt;
    } catch {}
      ...
      if (res.ok) {
        ...
        if (user?.id) {
          ...
          const data = await api(
            `user_roles?email=eq.${encodeURIComponent(user.email)}&select=role`
          );
  ...
  const searchDrive = async (q) => {
    ...
    try {
      ...
      const authHeader = googleToken
        ...
        : `Bearer ${getToken()}`;
      console.log(
        "Drive search token type:",
        googleToken ? "Google OAuth" : "Supabase token"
      );
            ...
            >
              <div style={{ display: "flex", gap: 10 }}>
                <input
                  ...
                  placeholder="파일명으로 검색... 예) 로고, logo, brand, icon"
                  value={driveQuery}
                ...
                >
                  {driveLoading ? <span className="spin">⏳</span> : "검색"}
                </button>
              </div>
              <div
                style={{
          ...
          <div style={{ maxWidth: 680, margin: "0 auto" }}>
            ...
            <div style={{ marginBottom: 24 }}>
              ...
              <div style={{ fontSize: 13, color: "#9ca3af", lineHeight: 1.6 }}>
                아는 선에서 최대한 자세히 적어주세요. 빈칸이 많을수록 확인
                미팅이 길어집니다 😉
                <span
                  style={{
                    marginLeft: 10,
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
              ...
              >
                ...
                >
                  ...
                  >
                    01 — 요청 제목 <span style={{ color: "#ef4444" }}>*</span>
                  </label>
                  <div
                ...
                <input
                  className="inp"
                  placeholder="예) 3월 이벤트 SNS 배너 제작"
              ...
              >
                ...
                >
                  <div>
                    ...
                    <input
                      className="inp"
                      placeholder="예) 1920×1080px  /  A4  /  1:1"
                ...
                <div style={{ marginBottom: 14 }}>
                  ...
                  >
                    ...
                    <textarea
                      ...
                      placeholder="위 항목을 참고해서 자유롭게 작성해주세요"
                ...
                <div>
                  ...
                  >
                    ...
                    >
                      ...
                      >
                        · 참고할 이미지 URL, 링크, 핀터레스트 보드 등을 자유롭게
                        붙여넣어 주세요
                      </div>
                    </div>
                    <textarea
          ...
          >
            <div className="modal">
              <div style={{ padding: "28px 28px 0" }}>
                ...
                >
                  {[
                    { label: "요청자", value: selectedTicket.requester },
                    {
                      label: "디자인 마감 희망일",
                    ...
                    {
                      label: "요청 유형",
                      value: selectedTicket.type || "미지정",
                    },
                    {
                      label: "우선순위",
                      value: getPriority(selectedTicket.priority).label,
                    },
                    { label: "요청일", value: selectedTicket.requestDate },
                    {
                      label: "프로젝트 일정",
                ...
                {selectedTicket.attachments?.length > 0 && (
                  <div style={{ marginBottom: 14 }}>
                    <div
                      style={{ fontWeight: 700, fontSize: 13, marginBottom: 8 }}
                    >
                      📎 첨부파일 ({selectedTicket.attachments.length})
                    </div>
                    <div
                      style={{
                        display: "flex",
                ...
                <div style={{ marginBottom: 28 }}>
                  ...
                  >
                    💬 코멘트 ({selectedTicket.comments.length})
                  </div>
